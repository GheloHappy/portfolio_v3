const Home = () => {
    return (
        <div className="w-full h-screen bg-gradient-to-r from-[#060705] to-[#10460d] flex items-center justify-center">
            ...
            <div className="w-[60%] flex items-start justify-center h-full flex-col">
                ...
                <div className="text-[7rem] font-squada p-0 m-0 flex bg-gradient-to-b from-[#6CFD08] to-[#495f1f] text-transparent bg-clip-text">
