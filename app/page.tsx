          ...
          <div className="w-full md:w-[30%] flex flex-col items-center gap-5 ">
            ...
            >
              <div className="w-full bg-[#a0a4ad] rounded-full flex items-center justify-center flex-col">
                <img
                  src="https://ik.imagekit.io/ghelowee/Portfolio/img-removebg.png?updatedAt=1741418335430"
                  alt="profile"
              ...
              <div className="mt-10 flex flex-col">
                ...
                <div className="mt-5">
                  <p>
                    A dedicated programmer committed to empowering businesses by
                    transforming conventional apps into exceptional digital
                ...
                <div className="mt-5 w-full text-white flex items-center justify-center font-bold text-[1rem] px-2">
                  <a
                    href="/Maligaya-Ghelonico-G.-CV.pdf"
                    download
                ...
                <div className="mt-5 flex flex-col items-start justify-start gap-1">
                  ...
                  <span className="flex gap-2 items-center justify-center">
                    <SiGmail />
                    ghelonicomaligaya111@gmail.com
                  </span>
                </div>
              </div>
            </div>
